...
export const metadata: Metadata = {
  ...
  description: "Complete legal information for Spark Games including Terms and Conditions, Privacy Policy, and Cookies Policy. Commercial name of Naolito Games SL.",
};
...
export default function Legal() {
  return (
    <LegalLayout title="Terms and Conditions" lastUpdated="October 23, 2025">
      ...
      {/* General Terms of Service */}
      <section id="general-terms" className="mt-12">
      ...
      <section id="privacy-policy" className="mt-12">
        ...
        <h4>4.1 GDPR Rights (EEA Users)</h4>
        ...
        <p>
          Your information may be transferred to and processed in countries other than your country of residence. These countries may have different data protection laws than your country. When we transfer your information internationally, we implement appropriate safeguards to protect your information.
        </p>
      </section>

      {/* Cookies Policy */}
      <section id="cookies-policy" className="mt-12">
        ...
        <h4>2.2 Performance and Analytics Cookies</h4>
        <p>
        ...
        <h4>2.3 Advertising and Marketing Cookies</h4>
        <p>
        ...
        <h4>3.2 Mobile Device Settings</h4>
      ...
      <section id="contact-information" className="mt-12">
        ...
        <p>
          If you have any questions or comments about these Terms and Conditions, Privacy Policy, or Cookies Policy, please do not hesitate to contact us:
        </p>
        
        <div className="bg-gray-50 p-6 rounded-lg mt-4">
          <p className="mb-2"><strong>Company:</strong> Naolito Games SL</p>
          <p className="mb-2"><strong>Commercial Name:</strong> Spark Games</p>
        ...
        <p className="mt-6 text-sm text-gray-600">
          <strong>Supervisory Authority:</strong> If you are located in the EEA and have concerns about our processing of your personal information, you have the right to lodge a complaint with your local data protection authority.
        </p>
      </section>
